...
describe('Date utils', () => {
  ...
  it('should provide formatted date for am when HH is equal to 12', () => {
    const date = new Date('Fri Oct 20 2020 17:45:07 GMT+0530');

    expect(formatDate(date)).toEqual('20-Oct-2020 at 0:15 PM');
  });
