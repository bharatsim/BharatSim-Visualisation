...
function LatitudeChartConfig({ headers, updateConfigState, configKey, error, value }) {
...
LatitudeChartConfig.defaultProps = {
  error: '',
  value: '',
};

LatitudeChartConfig.propTypes = {
...
export default LatitudeChartConfig;
