...
function LongitudeChartConfig({ headers, updateConfigState, configKey, error, value }) {
...
LongitudeChartConfig.defaultProps = {
  error: '',
  value: '',
};

LongitudeChartConfig.propTypes = {
...
export default LongitudeChartConfig;
